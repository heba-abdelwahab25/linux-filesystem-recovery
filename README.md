...
├──**v1.1-Incident-recovery**: Recovery process of the hidden directory from the backup disk image, including commands, logs, and       │                               screenshots. -the same where taken for the real incident-
